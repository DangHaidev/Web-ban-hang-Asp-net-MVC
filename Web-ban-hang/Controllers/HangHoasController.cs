...
namespace Web_ban_hang.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(HDangShopContext context)
        {
            _context = context;
        }
        ...
        {
            var hDangShopContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HDangShopContext.HangHoas'  is null.");
            }
            var hangHoa = await _context.HangHoas.FindAsync(id);
            if (hangHoa != null)
            {
